...
export function Pricing({ onBook }: Props) {
  const tiers = [
    ...
    { name: 'Індивідуальні', tagline: 'Найшвидший прогрес', price: '1 500', per: 'за 60 хв',
      bullets: ['1-на-1 з тренером, без розмиття уваги', 'Гнучкий графік: будь-який вільний час', 'Особистий план з відеорозбором', 'Абонемент 12 занять — 15 000 ₴'],
      cta: 'Записатись на індивідуальне', tag: null },
    { name: 'Групові', tagline: 'Малі групи до 6 осіб', price: '500', per: 'за 90 хв',
      bullets: ['Постійний склад групи — є з ким спарингувати', 'Фіксований розклад, тренування 2–3 рази на тиждень', 'Внутрішні турніри школи', 'Навчання з нуля до впевненої гри'],
    ...
    <section className="section" id="pricing">
      <div className="container-x">
        ...
        <div data-anim="fade-up" style={{ marginTop: 32, padding: 28, border: '1px solid var(--line-soft)', borderRadius: 'var(--r-lg)', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 24, background: 'var(--surface)' }}>
          {[
            { t: 'Майстер-клас', p: '2 500 ₴ / 60 хв', d: 'Інтенсив на конкретну техніку' },
            { t: 'Підготовка до турнірів', p: 'Індивідуально', d: 'Цільова програма під дату змагань' },
            { t: 'Корпоративні', p: '3 000 ₴ / 90 хв', d: 'Тімбілдинг, івенти для команд' },
            { t: 'Сертифікат у подарунок', p: '800 ₴', d: 'Заняття як подарунок коханій людині' },
          ].map((x, i) => (
            <div key={i}>
