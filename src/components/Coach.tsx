        ...
        <div className="coach-card" data-anim="fade-up">
          ...
          <div className="coach-info">
            ...
            <p style={{ color: 'var(--ink-2)', lineHeight: 1.6, margin: 0 }}>
              Більше 23 років тренерської практики (з 2000 року). Підготував 16 майстрів спорту та виховав чемпіонів України, Європи і світу. Навчає дітей від 8 років і дорослих — від новачків до спортсменів високого рівня.
            </p>
