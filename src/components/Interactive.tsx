...
export function Features() {
  const items = [
    ...
    { i: '02', t: 'Столи преміум-класу', d: 'Професійні більярдні столи з якісним сукном. Обладнання для серйозних тренувань — таке саме, як на офіційних змаганнях.' },
...
export function Glossary() {
  const terms = [
    { t: "Накат", d: "Удар з верхнім ефектом — біла куля продовжує рух уперед після зіткнення з прицільною." },
    { t: "Контра", d: "Удар, при якому біла куля різко відскакує назад після зіткнення — протилежний до накату." },
    { t: "Стоп", d: "Удар без ефекту — біла куля повністю зупиняється в точці зіткнення з прицільною." },
    { t: "Рест", d: "Спеціальна підставка-місток для кия, яка допомагає виконати удар при незручному положенні." },
    { t: "Відкат", d: "Удар з нижнім ефектом — біла куля повертається назад після контакту з прицільною." },
    { t: "Плант", d: "Комбінаційний удар через посередника — біла б’є в одну кулю, яка відправляє іншу в лузу." },
  ];
